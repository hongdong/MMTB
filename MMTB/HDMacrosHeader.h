...
#ifndef HDMacrosHeader_h
#define HDMacrosHeader_h
...
#define HDSharedAppDelegate ((AppDelegate *)[UIApplication sharedApplication].delegate)
...
//约满颜色
#define RemainY [UIColor colorWithHexString:@"7ED321"]
//未约满
#define RemainN [UIColor colorWithHexString:@"D0021B"]
